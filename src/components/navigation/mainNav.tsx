...
const MainNav = () => {
  const {userId}= useContext(AuthContext);
    return (
        ...
        <Menu theme="dark" style={{flex:"auto", display:"flex"}} mode="horizontal" >
          <Menu.Item key="1">
          ...
          { userId ? <SubMenu style={{marginLeft:"auto"}}  icon={<UserOutlined />}>
        ...
        </SubMenu> : <Menu.Item style={{marginLeft:"auto"}}  key="3">
